...
function GitHubSignUpButton() {
  ...
  return (
    <a
      href={href}
      className="w-full flex items-center justify-center gap-2.5 border-[3px] border-lily/30 hover:border-lily/60 text-lily rounded-full py-3 text-sm font-extrabold transition-colors cursor-pointer"
    >
